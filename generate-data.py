...
weights = logistic_regression(simulated_separableish_features, simulated_labels, num_steps = 300000, learning_rate = 5e-5, intercept = intercept, features = features)
print('ok')
